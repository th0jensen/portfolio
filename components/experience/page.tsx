...
function RepoCard({
	...
	return (
		<a
			...
			className={`group glass-card overflow-hidden rounded-2xl p-6 smooth-transition hover:shadow-lg hover:border-border/60 flex flex-col ${
				sizeClasses[size]
			}`}
		>
			...
			<div className='flex items-center gap-4 text-sm text-muted-foreground mt-auto pt-4 border-t border-border/30 flex-wrap'>
				{repo.language && (
