...
function ConstructionCard() {
	return (
		<div className='max-w-md mx-auto'>
			...
			<div className='py-4'>
				<p className='mb-8 text-muted-foreground'>I'm currently working on exciting new projects to showcase in this section. Please check back soon for updates!</p>
