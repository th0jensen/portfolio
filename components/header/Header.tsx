...
export default function Header({
	...
	const normalizedPath = currentPath.endsWith('/') && currentPath.length > 1
		...
		: currentPath
	const isHomePath = normalizedPath === localeRoot || normalizedPath === '/'
	...
	const currentLocale =
		localesWithHref.find((l) => l.code === locale) || localesWithHref[0]
	const nameHref = isHomePath ? '#hero' : localeRoot
