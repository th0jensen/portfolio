...
export const FALLBACK_REPOS: FormattedRepo[] = [
	{
		...
		description:
			'extension_host: Fix Windows manifest paths when uploading extensions to WSL remote',
		url: 'https://github.com/zed-industries/zed/pull/50653',
		stars: 0,
		forks: 0,
		language: 'Rust',
