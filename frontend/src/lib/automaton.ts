...
const paint = (value: number, label: string, color: string, lightColor: string): PaintState => ({
  value,
  label,
  color,
  lightColor,
});
const dead = paint(0, 'Dead', '#000000', '#ffffff');
const alive = paint(1, 'Alive', '#ffffff', '#111827');
...
export const automata: readonly AutomatonDefinition[] = [
  ...
  },
  {
    ...
    defaultState: 1,
    states: [dead, paint(1, 'Alive', '#78ff78', '#16813e')],
  },
  {
    id: 2,
    name: "Brian's Brain",
    ...
    defaultState: 1,
    states: [dead, alive, paint(2, 'Dying', '#5078ff', '#3156c7')],
  },
  {
    id: 3,
    name: 'Wireworld',
    ...
    defaultState: 3,
    states: [
      paint(0, 'Empty', '#000000', '#ffffff'),
      paint(3, 'Conductor', '#1c2b23', '#557a5f'),
      paint(1, 'Electron head', '#1450dc', '#123fae'),
      paint(2, 'Electron tail', '#848aab', '#646b87'),
    ],
  },
] as const;
